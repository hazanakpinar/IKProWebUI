...
import '../assets/style/YoneticiAnasayfa.scss';
        ...
        <div
            ...
            <div className="text-center mt-2 mb-10">
                <h2 className="font-semibold">
                    {adminDetay.adi} {adminDetay.soyadi}
                </h2>
            ...
            <ul className="py-4 mt-2 text-gray-700 flex items-center justify-around">
                <li className="flex flex-col items-center space-evenly">
                    ...
                    <div>
                        <strong>Email:</strong> {adminDetay.email}
                    </div>
                </li>
                <li className="flex flex-col items-center space-evenly">
                    <svg
                    ...
                    <div>
                        <strong>Telefon:</strong> {adminDetay.phoneNumber}
                    </div>
                </li>
                <li className="flex flex-col items-center space-evenly">
                    <svg
                    ...
                    <div>
                        <strong>Adres:</strong> {adminDetay.adres}
                    </div>
                </li>
                <li className="flex flex-col items-center space-evenly">
                    <svg
                    ...
                    <div>
                        <strong>Departman:</strong> {adminDetay.departman}
                    </div>
                </li>
            </ul>
            <div className="p-4 border-t mx-8 mt-2">
                <Link
                    to={`/YoneticiDetay/${adminDetay.id}`}
